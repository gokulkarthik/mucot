...
from engine import CustomTrainer, CustomCallback, create_tokenizer, create_model
...
def main(args):
    ...
    dataset_test_eval, dataset_test_tokenized_eval = load_dataset(args=args, split='test', mode='test', tokenizer=tokenizer)
    ...
    trainer = CustomTrainer(
        ...
        callbacks = [EarlyStoppingCallback(early_stopping_patience = 2), 
            CustomCallback(dataset=dataset_test_eval, dataset_tokenized=dataset_test_tokenized_eval)]
    )
