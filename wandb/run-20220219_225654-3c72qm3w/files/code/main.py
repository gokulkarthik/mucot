...
def main(args):
    ...
    # Final Evaluation
    evaluate_model(model, tokenizer, dataset_train_4eval, dataset_test_tokenized_4eval, prefix='train', run_name=run_name)
    evaluate_model(model, tokenizer, dataset_test_4eval, dataset_test_tokenized_4eval, prefix='test', run_name=run_name)

    # train_predictions_raw = trainer.predict(dataset_train_tokenized_4eval)
    # train_predictions = postprocess_qa_predictions(dataset_train_4eval, dataset_train_tokenized_4eval, 
